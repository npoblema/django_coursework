...
urlpatterns = [
    ...
    path(
        'mailing/recipients/<int:pk>/update/',
        RecipientUpdateView.as_view(),
        name='recipient_update'),
    path(
        'mailing/recipients/<int:pk>/delete/',
    ...
    path(
        'mailing/<int:pk>/send/',
        SendMailingView.as_view(),
        name='send_mailing'),
    path(
        'mailing/<int:mailing_id>/statistics/',
        mailing_statistics_detail,
        name='mailing_statistics_detail'),
    path(
        'mailing/statistics/',
        mailing_statistics_list,
